...
public class Tools {
    ...
    public static void adjustFontScale(Configuration configuration, Context mContext) {
        if (configuration.fontScale > 1) {
            ...
            Log.e("fontScale",
                    "fontScale=" + configuration.fontScale); //Custom Log class, you can use Log.w
            Log.e("fontScale", "font too big. scale down..."); //Custom Log class, you can use Log.w
            configuration.fontScale = (float) .85;
            DisplayMetrics metrics = mContext.getResources().getDisplayMetrics();
            WindowManager wm = (WindowManager) mContext.getSystemService(WINDOW_SERVICE);
            wm.getDefaultDisplay().getMetrics(metrics);
            metrics.scaledDensity = configuration.fontScale * metrics.density;
...
/*
    public static void setImageUrl(@DrawableRes int drawable, ImageView img) {
        try {
            ...
            Glide.with(img.getContext()).load(drawable)
...
//    public static void displayImageRound(final Context ctx, final ImageView img,
...
/*    public static GoogleMap configActivityMaps(GoogleMap googleMap) {
    ...
    public static void shareText(String subject, String body, Context mContext) {
